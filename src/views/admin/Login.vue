    ...
    <div>
        <v-app-bar dense elevation="0" color="#f2f2f2">
            <v-row no-gutters>
                ...
                <v-col cols="2" class="pt-5"><div class="text-body-1"><strong>闽大在线超市后台管理</strong></div></v-col>
                <v-spacer/>
        ...
        <v-main>
            <v-container>
                ...
                <div class="text-h4" id="title" v-text="loginByPhone ? '短信验证码登录' : '闽大超市后台管理员'"></div>
                ...
                <v-row no-gutters>
                    ...
                    <v-col cols="4">
                        ...
                        <v-btn color="#ca141d" style="color: white"
                               block large
                               :disabled="isEmpty"
                               @click="handlerLogin"
                            ><strong>登录</strong>
                        ...
                        <v-card height="50px" class="mt-5 pt-0" elevation="0">
                            <v-row>
                                <v-col cols="2"></v-col>
                                <v-col cols="2"><v-btn text color="primary">注册</v-btn> </v-col>
